...
import com.stonebridge.quotesystem.business.entity.SysConfig;
import com.stonebridge.quotesystem.business.entity.dto.ShapeSpecImportDTO;
import com.stonebridge.quotesystem.business.mapper.ShapeMapper;
import com.stonebridge.quotesystem.business.mapper.SysConfigMapper;
import com.stonebridge.quotesystem.business.service.IPackSpecService;
...
import com.stonebridge.quotesystem.business.listener.ShapeSpecExcelListener;
...
public class BasicDataController {
    ...
    private final IPackSpecService packSpecService;

    private final SysConfigMapper sysConfigMapper;

    // --- 器型表维护 ---
    @PreAuthorize("hasAuthority('basic:page')")
    ...
    @PreAuthorize("hasAuthority('basic:delete')")
    ...
    @PreAuthorize("hasAuthority('basic:update')")
    ...
    @PreAuthorize("hasAuthority('basic:import')")
